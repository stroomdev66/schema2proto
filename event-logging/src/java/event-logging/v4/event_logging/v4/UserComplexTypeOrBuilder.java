...
public interface UserComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.UserComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.UserComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.UserComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.UserDetailsComplexType getUserDetails();
  /**
   * <pre>
   * The details of the person represented by the user account or identity.
   * </pre>
   ...
   * <code>.event_logging.v4.UserDetailsComplexType user_details = 13 [json_name = "userDetails"];</code>
   */
  event-logging.v4.event_logging.v4.UserDetailsComplexTypeOrBuilder getUserDetailsOrBuilder();
