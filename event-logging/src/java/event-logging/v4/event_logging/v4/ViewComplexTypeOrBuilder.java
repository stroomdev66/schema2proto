...
public interface ViewComplexTypeOrBuilder extends
   ...
   */
  java.util.List<event-logging.v4.event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType> 
      getChoiceWrapperList();
  /**
   * <code>repeated .event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType getChoiceWrapper(int index);
  /**
   * <code>repeated .event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
   ...
   * <code>repeated .event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  java.util.List<? extends event-logging.v4.event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexTypeOrBuilder> 
      getChoiceWrapperOrBuilderList();
  /**
   * <code>repeated .event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.ViewComplexType.ChoiceWrapperViewComplexTypeOrBuilder getChoiceWrapperOrBuilder(
      int index);
