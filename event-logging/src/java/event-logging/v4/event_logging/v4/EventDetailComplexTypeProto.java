...
public final class EventDetailComplexTypeProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ng.v4.DataComplexTypeB\010\272H\005\222\001\002\010\000R\004dataB\344\001" +
      "\n!event-logging.v4.event_logging.v4B\033Eve" +
      "ntDetailComplexTypeProtoP\001ZEgithub.com/g" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          event-logging.v4.event_logging.v4.AlertComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ApprovalComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.AuthenticateComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.AuthoriseComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.CopyComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.CreateComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.DataComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.DeleteComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ExportComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ImportComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.InstallComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.MoveComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.NetworkEventActionComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.PrintComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ProcessComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.PurposeComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ReceiveComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.SearchComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.SendComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.UninstallComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.UpdateComplexTypeProto.getDescriptor(),
          event-logging.v4.event_logging.v4.ViewComplexTypeProto.getDescriptor(),
