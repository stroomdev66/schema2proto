...
public interface EventsTypeOrBuilder extends
   ...
   * @return The version.
   */
  event-logging.v4.event_logging.v4.VersionSimpleType getVersion();
   ...
   */
  java.util.List<event-logging.v4.event_logging.v4.EventsType.EventType> 
      getEventList();
  /**
   * <pre>
   * A single event that has occurred and been recorded.
   ...
   * <code>repeated .event_logging.v4.EventsType.EventType event = 3 [json_name = "event", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.EventsType.EventType getEvent(int index);
  /**
   * <pre>
   * A single event that has occurred and been recorded.
   * </pre>
   ...
   * <code>repeated .event_logging.v4.EventsType.EventType event = 3 [json_name = "event", (.buf.validate.field) = { ... }</code>
   */
  java.util.List<? extends event-logging.v4.event_logging.v4.EventsType.EventTypeOrBuilder> 
   ...
   * <code>repeated .event_logging.v4.EventsType.EventType event = 3 [json_name = "event", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.EventsType.EventTypeOrBuilder getEventOrBuilder(
      int index);
}
