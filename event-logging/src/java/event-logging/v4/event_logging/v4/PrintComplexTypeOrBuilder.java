...
public interface PrintComplexTypeOrBuilder extends
   ...
   * @return The action.
   */
  event-logging.v4.event_logging.v4.PrintActionSimpleType getAction();
   ...
   * @return The printJob.
   */
  event-logging.v4.event_logging.v4.PrintComplexType.PrintJobType getPrintJob();
  /**
   * <pre>
   * Describes the print job that the event relates to.
   * </pre>
   ...
   * <code>.event_logging.v4.PrintComplexType.PrintJobType print_job = 2 [json_name = "printJob", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.PrintComplexType.PrintJobTypeOrBuilder getPrintJobOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.PrintComplexType.PrintSettingsType getPrintSettings();
  /**
   * <pre>
   * The printer settings that are to be used for the print job.
   * </pre>
   ...
   * <code>.event_logging.v4.PrintComplexType.PrintSettingsType print_settings = 3 [json_name = "printSettings"];</code>
   */
  event-logging.v4.event_logging.v4.PrintComplexType.PrintSettingsTypeOrBuilder getPrintSettingsOrBuilder();
   ...
   * @return The printer.
   */
  event-logging.v4.event_logging.v4.DeviceComplexType getPrinter();
  /**
   * <pre>
   * Describes the printer to use for the print job.
   * </pre>
   ...
   * <code>.event_logging.v4.DeviceComplexType printer = 4 [json_name = "printer"];</code>
   */
  event-logging.v4.event_logging.v4.DeviceComplexTypeOrBuilder getPrinterOrBuilder();
