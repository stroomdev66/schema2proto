...
public interface SearchComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.SearchComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.SearchComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.SearchComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.SearchComplexType.DataSourcesType getDataSources();
  /**
   * <pre>
   * A collection of Datasource definitions that are referenced by the criteria/query
   * </pre>
   ...
   * <code>.event_logging.v4.SearchComplexType.DataSourcesType data_sources = 21 [json_name = "dataSources"];</code>
   */
  event-logging.v4.event_logging.v4.SearchComplexType.DataSourcesTypeOrBuilder getDataSourcesOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.SearchComplexType.ResultPageType getResultPage();
  /**
   * <pre>
   * Details of the page (or sub-set) of results actually displayed/returned to the user, if known at query time.
   * </pre>
   ...
   * <code>.event_logging.v4.SearchComplexType.ResultPageType result_page = 23 [json_name = "resultPage"];</code>
   */
  event-logging.v4.event_logging.v4.SearchComplexType.ResultPageTypeOrBuilder getResultPageOrBuilder();
