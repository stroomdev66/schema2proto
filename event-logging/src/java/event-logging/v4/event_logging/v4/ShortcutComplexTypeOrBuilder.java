...
public interface ShortcutComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.ShortcutComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.ShortcutComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.ShortcutComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   * @return The hash.
   */
  event-logging.v4.event_logging.v4.HashComplexType getHash();
  /**
   * <pre>
   * Describes the output of a hash function and the type of has function used.
   * </pre>
   ...
   * <code>.event_logging.v4.HashComplexType hash = 17 [json_name = "hash"];</code>
   */
  event-logging.v4.event_logging.v4.HashComplexTypeOrBuilder getHashOrBuilder();
