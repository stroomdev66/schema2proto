...
public interface NotComplexTypeOrBuilder extends
   ...
   */
  java.util.List<event-logging.v4.event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType> 
      getChoiceWrapperList();
  /**
   * <code>repeated .event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType getChoiceWrapper(int index);
  /**
   * <code>repeated .event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
   ...
   * <code>repeated .event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  java.util.List<? extends event-logging.v4.event_logging.v4.NotComplexType.ChoiceWrapperNotComplexTypeOrBuilder> 
      getChoiceWrapperOrBuilderList();
  /**
   * <code>repeated .event_logging.v4.NotComplexType.ChoiceWrapperNotComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.NotComplexType.ChoiceWrapperNotComplexTypeOrBuilder getChoiceWrapperOrBuilder(
      int index);
}
