...
public interface LocationComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.CoordinatesComplexType getCoordinates();
  /**
   * <pre>
   * The geographic coordinates of the location (i.e. the latitude/longitude).
   * </pre>
   ...
   * <code>.event_logging.v4.CoordinatesComplexType coordinates = 42 [json_name = "coordinates"];</code>
   */
  event-logging.v4.event_logging.v4.CoordinatesComplexTypeOrBuilder getCoordinatesOrBuilder();
