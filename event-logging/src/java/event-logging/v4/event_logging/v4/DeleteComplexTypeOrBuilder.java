...
public interface DeleteComplexTypeOrBuilder extends
   ...
   */
  java.util.List<event-logging.v4.event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType> 
      getChoiceWrapperList();
  /**
   * <code>repeated .event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType getChoiceWrapper(int index);
  /**
   * <code>repeated .event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
   ...
   * <code>repeated .event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  java.util.List<? extends event-logging.v4.event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexTypeOrBuilder> 
      getChoiceWrapperOrBuilderList();
  /**
   * <code>repeated .event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexTypeOrBuilder getChoiceWrapperOrBuilder(
      int index);
