...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return event-logging.v4.event_logging.v4.EventTimeComplexTypeProto.internal_static_event_logging_v4_EventTimeComplexType_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return event-logging.v4.event_logging.v4.EventTimeComplexTypeProto.internal_static_event_logging_v4_EventTimeComplexType_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            event-logging.v4.event_logging.v4.EventTimeComplexType.class, event-logging.v4.event_logging.v4.EventTimeComplexType.Builder.class);
  }
  ...
  private event-logging.v4.event_logging.v4.DeviceComplexType timeSource_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public event-logging.v4.event_logging.v4.DeviceComplexType getTimeSource() {
    return timeSource_ == null ? event-logging.v4.event_logging.v4.DeviceComplexType.getDefaultInstance() : timeSource_;
  }
  /**
   * <pre>
   * This is an optional element to be used to indicate the time source that the event creation time has been synchronised with. In most circumstances it is assumed that the event time has been synchronised with the corporate time service where the generating device resides so the inclusion of this element is not required.
   ...
   */
  @java.lang.Override
  public event-logging.v4.event_logging.v4.DeviceComplexTypeOrBuilder getTimeSourceOrBuilder() {
    return timeSource_ == null ? event-logging.v4.event_logging.v4.DeviceComplexType.getDefaultInstance() : timeSource_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof event-logging.v4.event_logging.v4.EventTimeComplexType)) {
      return super.equals(obj);
    }
    event-logging.v4.event_logging.v4.EventTimeComplexType other = (event-logging.v4.event_logging.v4.EventTimeComplexType) obj;
  ...
  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseFrom(
  ...
  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseFrom(
  ...
  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static event-logging.v4.event_logging.v4.EventTimeComplexType parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
  ...
  public static Builder newBuilder(event-logging.v4.event_logging.v4.EventTimeComplexType prototype) {
  ...
  public static final class Builder extends
      ...
      event-logging.v4.event_logging.v4.EventTimeComplexTypeOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return event-logging.v4.event_logging.v4.EventTimeComplexTypeProto.internal_static_event_logging_v4_EventTimeComplexType_descriptor;
    }
    ...
    // Construct using event-logging.v4.event_logging.v4.EventTimeComplexType.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public event-logging.v4.event_logging.v4.EventTimeComplexType getDefaultInstanceForType() {
      return event-logging.v4.event_logging.v4.EventTimeComplexType.getDefaultInstance();
    }

    @java.lang.Override
    public event-logging.v4.event_logging.v4.EventTimeComplexType build() {
      event-logging.v4.event_logging.v4.EventTimeComplexType result = buildPartial();
    ...
    @java.lang.Override
    public event-logging.v4.event_logging.v4.EventTimeComplexType buildPartial() {
      event-logging.v4.event_logging.v4.EventTimeComplexType result = new event-logging.v4.event_logging.v4.EventTimeComplexType(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(event-logging.v4.event_logging.v4.EventTimeComplexType result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof event-logging.v4.event_logging.v4.EventTimeComplexType) {
        return mergeFrom((event-logging.v4.event_logging.v4.EventTimeComplexType)other);
      } else {
    ...
    public Builder mergeFrom(event-logging.v4.event_logging.v4.EventTimeComplexType other) {
      if (other == event-logging.v4.event_logging.v4.EventTimeComplexType.getDefaultInstance()) return this;
    ...
    private event-logging.v4.event_logging.v4.DeviceComplexType timeSource_;
    private com.google.protobuf.SingleFieldBuilder<
        event-logging.v4.event_logging.v4.DeviceComplexType, event-logging.v4.event_logging.v4.DeviceComplexType.Builder, event-logging.v4.event_logging.v4.DeviceComplexTypeOrBuilder> timeSourceBuilder_;
    /**
     * <pre>
     * This is an optional element to be used to indicate the time source that the event creation time has been synchronised with. In most circumstances it is assumed that the event time has been synchronised with the corporate time service where the generating device resides so the inclusion of this element is not required.
     * </pre>
     ...
     * <code>.event_logging.v4.DeviceComplexType time_source = 2 [json_name = "timeSource"];</code>
     */
    public Builder setTimeSource(event-logging.v4.event_logging.v4.DeviceComplexType value) {
      if (timeSourceBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.event_logging.v4.DeviceComplexType time_source = 2 [json_name = "timeSource"];</code>
     */
    public Builder mergeTimeSource(event-logging.v4.event_logging.v4.DeviceComplexType value) {
      if (timeSourceBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          timeSource_ != null &&
          timeSource_ != event-logging.v4.event_logging.v4.DeviceComplexType.getDefaultInstance()) {
     ...
     * <code>.event_logging.v4.DeviceComplexType time_source = 2 [json_name = "timeSource"];</code>
     */
    public event-logging.v4.event_logging.v4.DeviceComplexType.Builder getTimeSourceBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
    ...
    public event-logging.v4.event_logging.v4.DeviceComplexTypeOrBuilder getTimeSourceOrBuilder() {
      if (timeSourceBuilder_ != null) {
        ...
        return timeSource_ == null ?
            event-logging.v4.event_logging.v4.DeviceComplexType.getDefaultInstance() : timeSource_;
      }
    }
    /**
     * <pre>
  ...
  private static final event-logging.v4.event_logging.v4.EventTimeComplexType DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new event-logging.v4.event_logging.v4.EventTimeComplexType();
  }

  public static event-logging.v4.event_logging.v4.EventTimeComplexType getDefaultInstance() {
