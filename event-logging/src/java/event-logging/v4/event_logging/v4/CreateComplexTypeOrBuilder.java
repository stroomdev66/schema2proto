...
public interface CreateComplexTypeOrBuilder extends
   ...
   */
  java.util.List<event-logging.v4.event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType> 
      getChoiceWrapperList();
  /**
   * <code>repeated .event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType getChoiceWrapper(int index);
  /**
   * <code>repeated .event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
   ...
   * <code>repeated .event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  java.util.List<? extends event-logging.v4.event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexTypeOrBuilder> 
      getChoiceWrapperOrBuilderList();
  /**
   * <code>repeated .event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexType choice_wrapper = 1 [json_name = "choiceWrapper", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.CreateComplexType.ChoiceWrapperCreateComplexTypeOrBuilder getChoiceWrapperOrBuilder(
      int index);
