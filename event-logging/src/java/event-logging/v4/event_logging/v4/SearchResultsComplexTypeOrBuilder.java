...
public interface SearchResultsComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.SearchResultsComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.DataSourcesType getDataSources();
  /**
   * <pre>
   * A collection of Datasource definitions that are referenced by the criteria/query
   * </pre>
   ...
   * <code>.event_logging.v4.SearchResultsComplexType.DataSourcesType data_sources = 11 [json_name = "dataSources"];</code>
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.DataSourcesTypeOrBuilder getDataSourcesOrBuilder();
   ...
   * @return The query.
   */
  event-logging.v4.event_logging.v4.QueryComplexType getQuery();
  /**
   * <pre>
   * Structure used to describe the query associated with a search event.
   * </pre>
   ...
   * <code>.event_logging.v4.QueryComplexType query = 12 [json_name = "query"];</code>
   */
  event-logging.v4.event_logging.v4.QueryComplexTypeOrBuilder getQueryOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.ResultPageType getResultPage();
  /**
   * <pre>
   * Details of the page (or sub-set) of results actually displayed/returned to the user, if known at query time.
   * </pre>
   ...
   * <code>.event_logging.v4.SearchResultsComplexType.ResultPageType result_page = 13 [json_name = "resultPage"];</code>
   */
  event-logging.v4.event_logging.v4.SearchResultsComplexType.ResultPageTypeOrBuilder getResultPageOrBuilder();
   ...
   * @return The results.
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexType getResults();
  /**
   * <pre>
   * Describes the results returned by the search if they are known at the time of the Search event (a synchronous search). If the results are not know at execution time (an asynchronous search) and will be viewed as part of a separate event then View/SearchResults can be used to model that event.
   * </pre>
   ...
   * <code>.event_logging.v4.MultiObjectComplexType results = 15 [json_name = "results"];</code>
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexTypeOrBuilder getResultsOrBuilder();
