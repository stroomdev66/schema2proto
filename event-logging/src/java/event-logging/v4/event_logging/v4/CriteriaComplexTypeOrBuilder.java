...
public interface CriteriaComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.CriteriaComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.DataSourcesType getDataSources();
  /**
   * <pre>
   * A collection of Datasource definitions that are referenced by the criteria/query
   * </pre>
   ...
   * <code>.event_logging.v4.CriteriaComplexType.DataSourcesType data_sources = 11 [json_name = "dataSources"];</code>
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.DataSourcesTypeOrBuilder getDataSourcesOrBuilder();
   ...
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.ResultPageType getResultPage();
  /**
   * <pre>
   * Details of the page (or sub-set) of results actually displayed/returned to the user, if known at query time.
   * </pre>
   ...
   * <code>.event_logging.v4.CriteriaComplexType.ResultPageType result_page = 13 [json_name = "resultPage"];</code>
   */
  event-logging.v4.event_logging.v4.CriteriaComplexType.ResultPageTypeOrBuilder getResultPageOrBuilder();
