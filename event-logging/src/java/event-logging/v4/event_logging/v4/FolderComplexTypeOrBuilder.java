...
public interface FolderComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.FolderComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.FolderComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.FolderComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
