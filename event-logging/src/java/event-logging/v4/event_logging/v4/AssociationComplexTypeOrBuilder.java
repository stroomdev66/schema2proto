...
public interface AssociationComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.AssociationComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.AssociationComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  event-logging.v4.event_logging.v4.AssociationComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
   ...
   * @return The objects.
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexType getObjects();
  /**
   * <pre>
   * The objects that have some form of link or association
   * </pre>
   ...
   * <code>.event_logging.v4.MultiObjectComplexType objects = 11 [json_name = "objects", (.buf.validate.field) = { ... }</code>
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexTypeOrBuilder getObjectsOrBuilder();
