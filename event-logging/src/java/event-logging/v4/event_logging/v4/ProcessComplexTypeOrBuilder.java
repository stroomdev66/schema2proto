...
public interface ProcessComplexTypeOrBuilder extends
   ...
   * @return The action.
   */
  event-logging.v4.event_logging.v4.ProcessActionSimpleType getAction();
   ...
   * @return The type.
   */
  event-logging.v4.event_logging.v4.ProcessTypeSimpleType getType();
   ...
   * @return The input.
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexType getInput();
  /**
   * <pre>
   * Any objects used as input to the process.
   * </pre>
   ...
   * <code>.event_logging.v4.MultiObjectComplexType input = 8 [json_name = "input"];</code>
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexTypeOrBuilder getInputOrBuilder();
   ...
   * @return The output.
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexType getOutput();
  /**
   * <pre>
   * Any objects output by the process
   * </pre>
   ...
   * <code>.event_logging.v4.MultiObjectComplexType output = 9 [json_name = "output"];</code>
   */
  event-logging.v4.event_logging.v4.MultiObjectComplexTypeOrBuilder getOutputOrBuilder();
