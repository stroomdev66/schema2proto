...
public interface AuthenticateComplexTypeOrBuilder extends
   ...
   * @return The action.
   */
  event-logging.v4.event_logging.v4.AuthenticateActionSimpleType getAction();
   ...
   */
  event-logging.v4.event_logging.v4.AuthenticateLogonTypeSimpleType getLogonType();
   ...
   * @return The outcome.
   */
  event-logging.v4.event_logging.v4.AuthenticateOutcomeComplexType getOutcome();
  /**
   * <pre>
   * Used to determine if the action was successful. If omitted it is assumed that the event was successful and was permitted.
   * </pre>
   ...
   * <code>.event_logging.v4.AuthenticateOutcomeComplexType outcome = 11 [json_name = "outcome"];</code>
   */
  event-logging.v4.event_logging.v4.AuthenticateOutcomeComplexTypeOrBuilder getOutcomeOrBuilder();
