...
public interface AuthenticateOutcomeComplexTypeOrBuilder extends
   ...
   */
  event-logging.v4.event_logging.v4.AuthenticateOutcomeComplexType.AuthServiceType getAuthService();
  /**
   * <pre>
   * A description of the authorisation service that was used to decide if the action was permitted.
   * </pre>
   ...
   * <code>.event_logging.v4.AuthenticateOutcomeComplexType.AuthServiceType auth_service = 3 [json_name = "authService"];</code>
   */
  event-logging.v4.event_logging.v4.AuthenticateOutcomeComplexType.AuthServiceTypeOrBuilder getAuthServiceOrBuilder();
   ...
   * @return The reason.
   */
  event-logging.v4.event_logging.v4.AuthenticateOutcomeReasonSimpleType getReason();
